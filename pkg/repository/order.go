...
func (s *OrderMongo) CreateFeedback(req model.ReqFeedback) error {
	...
	newFeedback := &model.FeedBack{ID: req.ID, Username: req.Username, UserID: req.UserID, OrderID: req.OrderID, OrganizationID: req.OrganizationID, Text: req.Text, Rating: req.Rating}
